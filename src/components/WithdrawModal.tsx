      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl max-w-lg w-full p-6 border border-slate-200 dark:border-slate-700 shadow-2xl space-y-5 my-8">
        ...
        <div className="p-3 bg-slate-900 text-white rounded-xl text-xs space-y-1">
          ...
          <p className="text-[11px] text-slate-300">
            Permintaan penarikan akan diverifikasi oleh Admin Panel sebelum ditransfer ke rekening bank Anda. Penarikan dibatasi 1 kali setiap 24 jam.
          </p>
        </div>
        ...
        >
          KIRIM PERMINTAAN PENARIKAN (1X/HARI)
        </button>
      </div>
    </div>
  );
